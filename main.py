...
flags.DEFINE_integer('restore_sess_num', 195, 'sess number of pretrained model')
flags.DEFINE_integer('restart_epoch', 200, 'train restart epoch') 
flags.DEFINE_integer('re_end_epoch', 1000, 'train re-end epoch')
